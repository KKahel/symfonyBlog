...
class Article
{
     ...
     * @Assert\NotBlank(
     *      message = "L'article doit avoir un contenu"
     * )
     * @AntiFlood()
     */
    private $contenu;
    ...
    /**
     * Add competenceArticles
     *
     * @param \Sdz\BlogBundle\Entity\ArticleCompetence $competenceArticles
     * @return Article
     */
    public function addCompetenceArticle(\Sdz\BlogBundle\Entity\ArticleCompetence $competenceArticles)
    {
        $this->competenceArticles[] = $competenceArticles;
        $competenceArticles->setArticle($this);
        return $this;
    }

    /**
     * Remove competenceArticles
     *
     * @param \Sdz\BlogBundle\Entity\ArticleCompetence $competenceArticles
     */
    public function removeCompetenceArticle(\Sdz\BlogBundle\Entity\ArticleCompetence $competenceArticles)
    {
        $this->competenceArticles->removeElement($competenceArticles);
    }

    /**
     * Get competenceArticles
     *
     * @return \Doctrine\Common\Collections\Collection 
     */
    public function getCompetenceArticles()
    {
        return $this->competenceArticles;
    }
